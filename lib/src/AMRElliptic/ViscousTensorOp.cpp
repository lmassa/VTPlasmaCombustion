        ...
        bool                 a_homoOnly)
{
  ...
  RefCountedPtr<LevelData<FArrayBox> > acoef( new LevelData<FArrayBox>(layout, 1, IntVect::Zero) );
  coarsenStuff(*eta, *lambda,  *acoef, *m_eta[ref], *m_lambda[ref],  *m_acoef[ref], refToDepth, s_coefficientAverageType);
