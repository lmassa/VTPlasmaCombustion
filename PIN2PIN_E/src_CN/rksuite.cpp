...
void RKSUITE::setup(int neq, Real tstart, Real ystart[], Real tend,
...
//      Real PRECISION  A(13,13), B(13), C(13), BHAT(13), R(11,6),
//     &                  E(7)
...
//      Real PRECISION  TOOSML, COST, SAFETY, EXPON, STBRAD, TANANG,
//     &                  RS, RS1, RS2, RS3, RS4
...
//      Real PRECISION  MCHEPS, DWARF, RNDOFF, SQRRMC, CUBRMC, TINY
//      INTEGER           OUTCH
...
void RKSUITE::uta(void (*f)(Real, Real*, Real*, Parameters& P), Real twant, Real& tgot,
...
//C  WORKSPACE
//C
//C     WORK(*)   - Real PRECISION array as used in SETUP
...
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C     .. Scalar Arguments ..
//      Real PRECISION  TGOT, TWANT
//      INTEGER           UFLAG
//C     .. Array Arguments ..
//      Real PRECISION  WORK(*), YGOT(*), YMAX(*), YPGOT(*)
...
void RKSUITE::stat(int& totfcn, int& stpcst, Real& waste, int& stpsok, Real& hnext)
{
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C
...
//C
   ...
   if (rkcom2.okstp <= 1) {
      ...
      waste = Real(rkcom2.flstp)/Real(rkcom2.flstp+rkcom2.okstp);
   }
   hnext = rkcom2.h;
//C
   label20:
...
void RKSUITE::glberr(Real rmserr[], Real& errmax, Real& terrmx, Real work[])
{
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C
...
//C  OUTPUT VARIABLES
//C
//C     RMSERR(*) - Real PRECISION array of length NEQ
...
void RKSUITE::ct(void (*f)(Real, Real*, Real*, Parameters& P), Real& tnow, Real ynow[],
...
//C  OUTPUT VARIABLES
//C
//C     TNOW      - Real PRECISION
//C                 Current value of the independent variable.
//C     YNOW(*)   - Real PRECISION array of length NEQ
//C                 Approximation to the true solution at TNOW.
//C     YPNOW(*)  - Real PRECISION array of length NEQ
...
//    INTEGER           CFLAG
//C     .. Array Arguments ..
//    Real PRECISION  WORK(*), YNOW(*), YPNOW(*)
//C     .. Subroutine Arguments ..
//    EXTERNAL          F
//C     .. Common Block for Problem Definition ..
//    Real PRECISION  TSTRT, TND, DIR, HSTRT, TOLR
...
//    Real PRECISION  ZERO, PT1, PT9, ONE, TWO, HUNDRD
//    PARAMETER         (ZERO=0.0D+0,PT1=0.1D+0,PT9=0.9D+0,ONE=1.0D+0,
//   &                  TWO=2.0D+0,HUNDRD=100.0D+0)
   const Real zero = 0.0, pt1 = 0.1, pt9 = 0.9, one = 1.0, two = 2.0,
      hundrd = 100.0;
//C     .. Local Scalars ..
   Real alpha, beta, err, hmin, htry, tau,
      temp1, temp2, ypnorm;
...
//C  and YPNOW(*).
      f(rkcom2.t,&work[rkcom3.pry],&work[rkcom3.pryp],rkparams);
      rkcom2.nfcn++;
      for (l = 0; l < rkcom1.neqn; l++) {
...
void RKSUITE::intrp(Real twant, char reqest[], int nwant, Real ywant[], Real ypwant[],
...
//C  WORKSPACE
//C
//C     WORK(*)   - Real PRECISION array as used in SETUP and CT
//C                 Do not alter the contents of this array.
//C
//C     WRKINT(*) - Real PRECISION array of length LENINT
//C                 Do not alter the contents of this array.
//C
//C     LENINT    - INTEGER
...
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C     .. Scalar Arguments ..
//      Real PRECISION  TWANT
//      INTEGER           LENINT, NWANT
//      CHARACTER*(*)     REQEST
//C     .. Array Arguments ..
//      Real PRECISION  WORK(*), WRKINT(*), YPWANT(*), YWANT(*)
//C     .. Subroutine Arguments ..
//      EXTERNAL          F
//C     .. Common Block for Problem Definition ..
//      Real PRECISION  TSTRT, TND, DIR, HSTRT, TOLR
...
void RKSUITE::reset(Real tendnu)
{
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C
...
//      SAVE   /RKCOM7/
//C     .. Parameters..
//      Real PRECISION  TEN, THIRD
//      PARAMETER         (TEN=10.0D+0,THIRD=1.0D+0/3.0D+0)
   const Real ten = 10.0, third = 1.0/3.0;
//C     .. External Subroutines ..
//      EXTERNAL          ENVIRN
//C     .. Intrinsic Functions ..
//      INTRINSIC         SQRT
...
void RKSUITE::envirn(int& outch, Real& mcheps, Real& dwarf)
{
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C
...
//C      .. Scalar Arguments ..  
//C      INTEGER           OUTCH
//C      Real PRECISION  DWARF, MCHEPS
//C      .. External Functions ..
//C      INTEGER           I1MACH
//C      Real PRECISION  D1MACH
//C      .. Executable Statements ..
//C
//C      OUTCH = I1MACH(2)
//C      MCHEPS = D1MACH(3)
...
//C      Real PRECISION  DWARF, MCHEPS
//C      .. External Functions ..
//C      Real PRECISION  X02AJF, X02AMF
//C      .. Executable Statements ..
//C
...
//      SAVE   /RKCOM7/
//C     .. Parameters ..
//      Real PRECISION  ONE, ZERO, TWO, FIFTY, FIVEPC
//      PARAMETER         (ONE=1.0D+0,ZERO=0.0D+0,TWO=2.0D+0,FIFTY=50.D+0,
//     &                  FIVEPC=0.05D+0)
   const Real one = 1.0, zero = 0.0, two = 2.0, fifty = 50.0, fivepc = 0.05;
//C     .. Local Scalars ..
   Real cdiff, diff;
   int i, j;
//C     .. Intrinsic Functions ..
...
//  120 CONTINUE
   ...
   if (rkcom5.fsal) {
      rkcom5.cost = Real(rkcom4.nstage-1);
   }
   else {
      rkcom5.cost = Real(rkcom4.nstage);
   }
//C
...
void RKSUITE::formi(void (*f)(Real, Real*, Real*, Parameters& P), int neq, int nwant, Real y[], Real yp[],
...
//      LOGICAL           CALSTG
//C     .. Array Arguments ..
//      Real PRECISION  P(*), STAGES(NEQ,*), XSTAGE(*), Y(*), YOLD(*),
//     &                  YP(*), YPOLD(*)
//C     .. Subroutine Arguments ..
//      EXTERNAL          F
//C     .. Common Block to hold Problem Status ..
...
//C
		 ...
		 &stages/*[1][7]*/[neq*(7-1)], rkparams);
               rkcom2.nfcn++;
            }
            else if (i == 10) {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,xstage, rkparams);
               rkcom2.nfcn++;
            }
            else {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,
                  &stages/*[1][1]*/[neq*(1-1)], rkparams);
               rkcom2.nfcn++;
            }
         }
      }
...
void RKSUITE::evali(Real y[], Real yp[], Real p /* [nwant][] */ [], Real twant,
...
//      CHARACTER*(*)     REQEST
//C     .. Array Arguments ..
//      Real PRECISION  P(NWANT,*), Y(*), YP(*), YPWANT(*), YWANT(*)
//C     .. Common Block to hold Problem Status ..
//      Real PRECISION  T, H, TOLD, HOLD
//      INTEGER           NFCN, SVNFCN, OKSTP, FLSTP
//      LOGICAL           FIRST, LAST
...
void RKSUITE::truerr(void (*f)(Real, Real*, Real*, Parameters& P), int neq, Real y[],
...
//      INTEGER           IER, NEQ
//C     .. Array Arguments ..
//      Real PRECISION  WEIGHT(*), Y(*), ZERRES(*), ZERROR(*),
...
//      SAVE   /RKCOM7/
//C     .. Parameters ..
//      Real PRECISION  PT1, TEN, DUMMY
//      PARAMETER         (PT1=0.1D0,TEN=10.0D0,DUMMY=1.0D0)
   const Real pt1 = 0.1, ten = 10.0, dummy = 1.0;
//C     .. Local Scalars ..
   Real diff, errmax, hmin, hsec, mxerlc, tsec, zlerr,
      ztest1, ztest2;
   int istep, l, level;
   bool ldummy, main;
//C     .. Local Arrays ..
...
//C  Advance TSEC and the dependent variables ZY(*) and ZYP(*).
      tsec = rkcom2.t - Real(rkcom5.nsec-istep)*hsec;
      for (l = 0; l < neq; l++) {
         zy[l] = zynew[l];
      }
//C
...
void RKSUITE::step(void (*f)(Real, Real*, Real*, Parameters& P), int neq, Real tnow,
...
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  ERR, HMIN, HTRY, TNOW, TOL
//      INTEGER           NEQ
//      LOGICAL           MAIN, PHASE2
//C     .. Array Arguments ..
//      Real PRECISION  ERREST(*), STAGES(NEQ,*), THRES(*), WEIGHT(*),
//     &                  Y(*), YNEW(*), YP(*)
//C     .. Subroutine Arguments ..
//      EXTERNAL          F
//C     .. Common Block for Problem Definition ..
...
//      SAVE   /RKCOM6/
//C     .. Parameters ..
//      Real PRECISION  ZERO, HALF, ONE
//      PARAMETER         (ZERO=0.0D0,HALF=0.5D0,ONE=1.0D0)
   const Real zero = 0.0, half = 0.5, one = 1.0;
//C     .. Local Scalars ..
   Real avgy, tstg;
   int i, j, l;
   bool cutbak;
...
//C
      ...
      f(tstg,ynew,/* stages[1][rkcom4.ptr[i]] */ &stages[neq*(rkcom4.ptr[i]-1)],rkparams);
//C
...
void RKSUITE::stepa(Real tnow, Real y[], Real yp[], Real tstg, Real ystg[],
...
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  HTRY, TNOW, TSTG
//      LOGICAL           CUTBAK
//C     .. Array Arguments ..
//      Real PRECISION  WEIGHT(*), Y(*), YP(*), YPSTG(*), YSTG(*)
//C     .. Common Block for Problem Definition ..
//      Real PRECISION  TSTRT, TND, DIR, HSTRT, TOLR
//      INTEGER           NEQN
//      COMMON /RKCOM1/   TSTRT, TND, DIR, HSTRT, TOLR, NEQN
...
//      PARAMETER         (ZERO=0.0D0)
   const Real zero = 0.0;
//C     .. Local Scalars ..
   Real argdif, fdiff, scl, tdiff, twt, wt, ynrm, ystgnm;
   int l;
//C     .. Intrinsic Functions ..
//      INTRINSIC         ABS, MAX, MIN
//C     .. Executable Statements ..
...
void RKSUITE::stepb(int neq, Real y[], Real yp[], Real h, Real ynew[],
...
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  ERR, H
//      INTEGER           NEQ
//      LOGICAL           MAIN
//C     .. Array Arguments ..
//      Real PRECISION  STAGES(NEQ,*), THRES(*), WEIGHT(*), Y(*),
//     &                  YNEW(*), YP(*)
//C     .. Common Block to hold Formula Definitions ..
//      Real PRECISION  A(13,13), B(13), C(13), BHAT(13), R(11,6),
//     &                  E(7)
...
void RKSUITE::stiff(void (*f)(Real, Real*, Real*, Parameters& P), Real havg, int& jflstp,
...
//C  Predict how much eXTRA WorK will be needed to reach TND.
            xtrawk = (rkcom5.cost*fabs((rkcom1.tnd-rkcom2.t)/havg))/Real(rkcom2.svnfcn+rkcom2.nfcn);
            ier = 4;
...
void RKSUITE::stiffa(void (*f)(Real, Real*, Real*, Parameters& P),Real x, Real y[],
...
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  HAVG, HNOW, X, XEND
//      INTEGER           MAXFCN
//      LOGICAL           STIF, UNSURE
//C     .. Array Arguments ..
//      Real PRECISION  FXY(*), V0(*), V1(*), V2(*), V3(*), VTEMP(*),
//     &                  WT(*), Y(*)
//C     .. Subroutine Arguments ..
//      EXTERNAL          F
//C     .. Common Block for Problem Definition ..
...
//      SAVE   /RKCOM7/
//C     .. Parameters..
//      Real PRECISION  LARGE
//      PARAMETER         (LARGE=1.0D+10)
//      Real PRECISION  ZERO, P001, P9, ONE, TWO, FIVE, FIFTH
//      PARAMETER         (ZERO=0.0D+0,P001=0.001D+0,P9=0.9D+0,ONE=1.0D+0,
//     &                  TWO=2.0D+0,FIVE=5.0D+0,FIFTH=0.2D+0)
   const Real large = 1.0e10;
   const Real zero = 0.0, p001 = 0.001, p9 = 0.9, one = 1.0;
   const Real two = 2.0, five = 5.0, fifth = 0.2;
//C     .. Local Scalars ..
   Real alpha1, alpha2, beta1, beta2, d1, d2, det1,
   ...
   bool rootre;
//C     .. Local Arrays ..
   Real r1[2], r2[2], root1[2], root2[2];
//C     .. External Functions ..
//      Real PRECISION  DOTPRD
//      EXTERNAL          DOTPRD
//C     .. External Subroutines ..
...
void RKSUITE::stiffb(Real v1v1, Real v0v1, Real v0v0, Real& rold,
...
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  RHO, ROLD, V0V0, V0V1, V1V1
//      LOGICAL           ROOTRE
//C     .. Array Arguments ..
//      Real PRECISION  ROOT1(2), ROOT2(2)
//C     .. Parameters..
//      Real PRECISION  ZERO, P001
//      PARAMETER         (ZERO=0.0D+0,P001=0.001D+0)
   const Real zero = 0.0, p001 = 0.001;
//C     .. Local Scalars ..
   Real det, r, res;
//C     .. Intrinsic Functions ..
//      INTRINSIC         ABS
...
void RKSUITE::stiffc(Real alpha, Real beta, Real r1[], Real r2[])
{
//C************************************************
//C**** NOT A DESIGNATED USER-CALLABLE ROUTINE ****
//C************************************************
...
//C     .. Array Arguments ..
//      Real PRECISION  R1(2), R2(2)
//C     .. Parameters..
//      Real PRECISION  ZERO, TWO
//      PARAMETER         (ZERO=0.0D+0,TWO=2.0D+0)
   const Real zero = 0.0, two = 2.0;
//C     .. Local Scalars ..
   Real disc, sqdisc, temp;
//C     .. Intrinsic Functions ..
//      INTRINSIC         ABS, SQRT
//C     .. Executable Statements ..
   temp = alpha/two;
...
void RKSUITE::stiffd(Real v[], Real havg, Real x, Real y[],
...
//C  Real PRECISION FUNCTION DOTPRD(U,V,WT,NEQ) to compute the dot (inner)
//C  product.  The vector VTEMP(*) is used for working storage.
//C
//C     .. Scalar Arguments ..
//      Real PRECISION  HAVG, SCALE, VDOTV, X, ZDOTZ
//C     .. Array Arguments ..
//      Real PRECISION  FXY(*), V(*), VTEMP(*), WT(*), Y(*), Z(*)
//C     .. Subroutine Arguments ..
//      EXTERNAL          F
//C     .. Common Block for Problem Definition ..
//      Real PRECISION  TSTRT, TND, DIR, HSTRT, TOLR
...
Real RKSUITE::dotprd(Real u[], Real v[], Real wt[], int neq)
{
//C************************************************
//C**** NOT A DESIGNATED USER-CALLABLE ROUTINE ****
//C************************************************
